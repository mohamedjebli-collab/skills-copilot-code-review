...
initial_announcements = [
    {
        "message": "🎉 Activity registration is now open! Sign up for your favourite extracurricular before spots fill up. Don't miss out!",
        "start_date": datetime(2026, 5, 1),
        "expiration_date": datetime(2026, 5, 31),
